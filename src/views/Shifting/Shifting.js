...
Service available within a city and between two cities</h2>
			...
			<label htmlFor="my-modal-5" className="btn bg-teal-500">Inside City</label>
            <ShiftModal></ShiftModal>
			<label htmlFor="my-modal-5" className="btn bg-amber-300">Outside City</label>
            <ShiftModalOutsidecities></ShiftModalOutsidecities></div>
	</div>
        </div>
        <div>
...
Service available within a city and between two cities</h2>
	...
	<div className="container mx-auto">
		<div className="flex flex-col lg:flex-row items-center justify-between">
			<h2 className="text-center text-2xl tracking-tighter font-bold">3 Bedroom hall and kitchen</h2>
			<h2 className="text-center text-green-600 text-sm tracking-tighter font-bold">For 3 bedroom, dining, drawing & kitchen
        Service available within a city and between two cities</h2>
	...
	<div className="container mx-auto">
		<div className="flex flex-col lg:flex-row items-center justify-between">
			<h2 className="text-center text-2xl tracking-tighter font-bold">4 Bedroom hall and kitchen</h2>
			<h2 className="text-center text-green-600 text-sm tracking-tighter font-bold">For 4 bedroom, dining, drawing & kitchen
            Service available within a city and between two cities</h2>
