...
import DetailsHouseImage from "../../DetailsHouseImage/DetailsHouseImage.jsx";
const OrderDetailsModal = ({ seeOrderDetails }) => {
  const house = seeOrderDetails?.orderHouse;
  ...
  return (
    <div>
      ...
      />
      <div className="modal">
        <div className="modal-box glass w-11/12 max-w-5xl mt-24">
