...
const Profile = () => {
  ...
  return (
    <div>
      <section className="p-6 bg-blue-200 dark:text-gray-50">
        <form
          novalidate=""
          action=""
            ...
            <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
              <div className="col-span-full sm:col-span-3">
                ...
                <input
                  ...
                  value={user.name}
                  className="w-full px-2 rounded-md focus:ring focus:ring-opacity-75 focus:ring-violet-400 dark:border-gray-700 dark:text-gray-900"
                />
              </div>
              ...
              <div className="col-span-full">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    disabled
                    type="button"
                    className="px-4 py-2 bg-sky-400 border rounded-md dark:border-gray-100"
                  >
                    Change
                  </button>
                </div>
